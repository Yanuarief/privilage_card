...
module.exports = {
	...
	mounted: function(){
        var vue = this
        $('#form-pelanggan').createForm({
            vue: vue,
            action: 'edit',
            rest:{
                api: rest["editpelanggan"],
                databyid: `${rest["pelangganbyid"]}?id=${vue.$route.params.id}`
            },
            back: 'pelanggan',
            form(datas){
            var datas = datas.data.data;
                return [
                    ...
                    $.inpradiobox('Jenis Kelamin','jenisKelamin','jenisKelamin',false,{
                        option: [
                            {
                                name: 'Laki-laki',
                                value: 'L',
                        ...
                        value: datas.jenis_kelamin
                    }),
                    $.inpradiobox('Status Menikah','statusMenikah','jenisKelamin',false,{
                        option: [
                            {
                                name: 'Menikah',
                                value: 'y',
                    ...
                    $.inptextarea('Kota','kota','kota',false,{
                        placeholder: 'Kota',
                        value:datas.kota
                    }),
